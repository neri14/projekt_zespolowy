...
/**
 * Created by Bartosz on 24.01.14.
 */
 ...
 * @version 1.3.0
 */
public class PullDownRefreshList extends ListView
{
    ...
    public PullDownRefreshList(Context context, AttributeSet attrs, int defStyle)
    {
